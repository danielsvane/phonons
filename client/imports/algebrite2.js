...
(function() {
  ...
  print_tensor_inner = function(p, j, k) {
    var ac, accumulator, i, ref1, ref2, retString;
    accumulator = "";
    i = 0;
    if (codeGen) {
      accumulator += print_str("[");
  ...
  f_equals_a = function(h, generalTransform) {
    ...
    for (fea_i = ae = ref2 = h, ref3 = tos; ref2 <= ref3 ? ae < ref3 : ae > ref3; fea_i = ref2 <= ref3 ? ++ae : --ae) {
      ...
      for (fea_j = af = ref4 = h, ref5 = tos; ref4 <= ref5 ? af < ref5 : af > ref5; fea_j = ref4 <= ref5 ? ++af : --af) {
        ...
        push(p3);
        if (DEBUG) {
          console.log("about to evaluate template expression: " + p5 + " binding METAA to " + get_binding(symbol(METAA)));
        }
        push(p5);
        if (generalTransform) {
          originalexpanding = expanding;
  ...
  defn_str = ["version=\"" + version + "\"", "e=exp(1)", "i=sqrt(-1)", "autoexpand=1", "trange=(-pi,pi)", "xrange=(-10,10)", "yrange=(-10,10)", "last=0", "trace=0", "printLeaveEAlone=1", "printLeaveXAlone=0", "cross(u,v)=(u[2]*v[3]-u[3]*v[2],u[3]*v[1]-u[1]*v[3],u[1]*v[2]-u[2]*v[1])", "curl(v)=(d(v[3],y)-d(v[2],z),d(v[1],z)-d(v[3],x),d(v[2],x)-d(v[1],y))", "div(v)=d(v[1],x)+d(v[2],y)+d(v[3],z)", "ln(x)=log(x)"];
  ...
  test_dependencies = function() {
    var CACHE_HITSMISS_DEBUGS, currentStateHash, original_CACHE_HITSMISS_DEBUGS, testResult;
    do_clearall();
    testResult = findDependenciesInScript('1');
    if (testResult[0] === "All local dependencies: . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively: " && testResult[1] === "1" && testResult[2] === "") {
    ...
    if (testResult[0] === "All local dependencies:  variable f depends on: x, g, ;  variable g depends on: f, ;  variable h depends on: g, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable f depends on: x, ;  f --> g -->  ... then f again,  variable g depends on: x, ;  g --> f -->  ... then g again,  variable h depends on: x, ;  h --> g --> f -->  ... then g again, " && testResult[1] === "" && testResult[2] === "// f is part of a cyclic dependency, no code generated.\n// g is part of a cyclic dependency, no code generated.\n// h is part of a cyclic dependency, no code generated.") {
    ...
    if (testResult[0] === "All local dependencies:  variable x depends on: y, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable x depends on: y, ; " && testResult[1] === "" && testResult[2] === "x = function (y) { return ( Math.pow(y, 2) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable x depends on: ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable x depends on: ; " && testResult[1] === "" && testResult[2] === "x = -1/2*Math.pow(2, (1/2));") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable x depends on: a, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable x depends on: a, ; " && testResult[1] === "" && testResult[2] === "x = 1/10*Math.pow(2, (1/2));") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable x depends on: t, y, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable x depends on: t, y, ; " && testResult[1] === "" && testResult[2] === "x = function (t, y) { return ( t*y*(6*Math.pow(t, 2) + Math.pow(y, 2) + 6*t*y) / ((t + y)*Math.pow((2*t + y), 2)) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable x depends on: y, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable x depends on: y, ; " && testResult[1] === "" && testResult[2] === "x = function (y) { return ( 1 + y ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable x depends on: ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable x depends on: ; " && testResult[1] === "" && testResult[2] === "x = 1;") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable f depends on: 'x, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable f depends on: 'x, ; " && testResult[1] === "" && testResult[2] === "f = function (x) { return ( x*x ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable f depends on: 'x, g, y, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable f depends on: 'x, g, y, ; " && testResult[1] === "" && testResult[2] === "f = function (g, y, x) { return ( g(y) + Math.pow(x, 2) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable y depends on: ;  variable f depends on: 'x, g, y, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable y depends on: ;  variable f depends on: 'x, g, ; " && testResult[1] === "" && testResult[2] === "y = 2;\nf = function (g, x) { return ( g(2) + Math.pow(x, 2) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable g depends on: 'x, ;  variable y depends on: ;  variable f depends on: 'x, g, y, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable g depends on: 'x, ;  variable y depends on: ;  variable f depends on: 'x, ; " && testResult[1] === "" && testResult[2] === "g = function (x) { return ( 2 + x ); }\ny = 2;\nf = function (x) { return ( 4 + Math.pow(x, 2) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    do_clearall();
    testResult = findDependenciesInScript('g(x) = x + 2\nf(x) = x * x + g(y)');
    if (testResult[0] === "All local dependencies:  variable g depends on: 'x, ;  variable f depends on: 'x, g, y, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable g depends on: 'x, ;  variable f depends on: 'x, y, ; " && testResult[1] === "" && testResult[2] === "g = function (x) { return ( 2 + x ); }\nf = function (y, x) { return ( 2 + y + Math.pow(x, 2) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable f depends on: a, b, c, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable f depends on: a, b, c, ; " && testResult[1] === "" && testResult[2] === "f = function (a, b, c) { return ( [-1/2*(Math.pow((Math.pow(b, 2) / (Math.pow(a, 2)) - 4*c / a), (1/2)) + b / a),1/2*(Math.pow((Math.pow(b, 2) / (Math.pow(a, 2)) - 4*c / a), (1/2)) - b / a)] ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable f depends on: a, b, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable f depends on: a, b, ; " && testResult[1] === "" && testResult[2] === "f = function (a, b) { return ( [0,-2*b / a] ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable f depends on: a, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable f depends on: a, ; " && testResult[1] === "" && testResult[2] === "f = function (a) { return ( -1 / (2*a) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable f depends on: a, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable f depends on: a, ; " && testResult[1] === "" && testResult[2] === "f = function (a) { return ( -1 / a ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable f depends on: y, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable f depends on: y, ; " && testResult[1] === "" && testResult[2] === "f = function (y) { return ( -2*Math.pow(y, 2) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable f depends on: ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable f depends on: ; " && testResult[1] === "" && testResult[2] === "f = 55;") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable a depends on: ;  variable f depends on: 'a, b, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable a depends on: ;  variable f depends on: 'a, b, ; " && testResult[1] === "" && testResult[2] === "a = 2;\nf = function (a, b) { return ( 1 + a + b ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    do_clearall();
    testResult = findDependenciesInScript('a = 2\nf = a+1');
    if (testResult[0] === "All local dependencies:  variable a depends on: ;  variable f depends on: a, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable a depends on: ;  variable f depends on: ; " && testResult[1] === "" && testResult[2] === "a = 2;\nf = 3;") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable a depends on: b, ;  variable f depends on: a, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable a depends on: b, ;  variable f depends on: b, ; " && testResult[1] === "" && testResult[2] === "a = function (b) { return ( b ); }\nf = function (b) { return ( 1 + b ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    do_clearall();
    testResult = findDependenciesInScript('a := b\nf(a) = a+1');
    if (testResult[0] === "All local dependencies:  variable a depends on: b, ;  variable f depends on: 'a, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable a depends on: b, ;  variable f depends on: 'a, ; " && testResult[1] === "" && testResult[2] === "a = function (b) { return ( b ); }\nf = function (a) { return ( 1 + a ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable b depends on: a, c, ; . Symbols with reassignments: b, . Symbols in expressions without assignments: . All dependencies recursively:  variable b depends on: a, c, ; " && testResult[1] === "" && testResult[2] === "b = function (a, c) { return ( 1 + a + c ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable a depends on: ; . Symbols with reassignments: a, . Symbols in expressions without assignments: . All dependencies recursively:  variable a depends on: ; " && testResult[1] === "" && testResult[2] === "" && testResult[5] === "Error: Stop: recursive evaluation of symbols: a -> a") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult.affectsVariables.length === 3 && testResult.affectsVariables.indexOf("c") !== -1 && testResult.affectsVariables.indexOf("a") !== -1 && testResult.affectsVariables.indexOf("PATTERN_DEPENDENCY") !== -1 && testResult.affectedBy.length === 3 && testResult.affectedBy.indexOf("d") !== -1 && testResult.affectedBy.indexOf("a") !== -1 && testResult.affectedBy.indexOf("PATTERN_DEPENDENCY") !== -1) {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult.affectsVariables.length === 1 && testResult.affectsVariables.indexOf("PCA") !== -1 && testResult.affectsVariables.indexOf("PATTERN_DEPENDENCY") === -1 && testResult.affectedBy.length === 1 && testResult.affectedBy.indexOf("PATTERN_DEPENDENCY") !== -1) {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult.affectsVariables.length === 1 && testResult.affectsVariables.indexOf("PATTERN_DEPENDENCY") !== -1 && testResult.affectedBy.length === 1 && testResult.affectedBy.indexOf("PATTERN_DEPENDENCY") !== -1) {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult[0] === "All local dependencies:  variable PCA depends on: 'M, ; . Symbols with reassignments: . Symbols in expressions without assignments: . All dependencies recursively:  variable PCA depends on: 'M, ; " && testResult[1] === "" && testResult[2] === "PCA = function (M) { return ( eig(cov(M)) ); }") {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency test. expected: " + testResult);
    }
    ...
    if (testResult.code === "PCA = function (M) { return ( cov(M) ); }" && testResult.latexResult === "$$PCA(M) = cov(M)$$" && testResult.result === "$$PCA(M) = cov(M)$$" && testResult.dependencyInfo.affectedBy[0] === "M" && testResult.dependencyInfo.affectedBy[1] === "PATTERN_DEPENDENCY" && testResult.dependencyInfo.affectsVariables.length === 1 && testResult.dependencyInfo.affectsVariables[0] === "PCA") {
      console.log("ok dependency test");
    } else {
    ...
    if (testResult.code === "" && testResult.latexResult === "$$3x$$" && testResult.result === "$$3x$$" && testResult.dependencyInfo.affectedBy.length === 2 && testResult.dependencyInfo.affectedBy[0] === "x" && testResult.dependencyInfo.affectedBy[1] === "PATTERN_DEPENDENCY" && testResult.dependencyInfo.affectsVariables.length === 0) {
      console.log("ok dependency test");
    } else {
    ...
    testResult = computeResultsAndJavaScriptFromAlgebra('x + x + x');
    if (testResult.code === "" && testResult.latexResult === "$$3y+6$$" && testResult.result === "$$3y+6$$" && testResult.dependencyInfo.affectedBy.length === 2 && testResult.dependencyInfo.affectedBy[0] === "x" && testResult.dependencyInfo.affectedBy[1] === "PATTERN_DEPENDENCY" && testResult.dependencyInfo.affectsVariables.length === 0) {
      console.log("ok dependency test");
    } else {
      console.log("fail dependency tests");
    }
  ...
  findDependenciesInScript = function(stringToBeParsed, dontGenerateCode) {
    var ae, af, ag, ah, aj, al, allReturnedLatexStrings, allReturnedPlainStrings, am, ao, ap, bodyForReadableSummaryOfGeneratedCode, cacheKey, cacheMissPenalty, currentStateHash, cyclesDescriptions, deQuotedDep, dependencyInfo, eachDependency, error, error1, error2, error3, frozen, generatedBody, generatedCode, i, indexOfEachReplacement, indexOfPartRemainingToBeParsed, inited, key, len, len1, len2, len3, len4, len5, len6, len7, n, newUserSymbol, originalUserSymbol, parameters, possiblyCached, readableSummaryOfGeneratedCode, recursedDependencies, ref2, replacementsFrom, replacementsTo, scriptEvaluation, stringToBeRun, testableString, timeStartFromAlgebra, toBeFrozen, toBePrinted, totalTime, userVariablesMentioned, value, variablesWithCycles;
    if (DEBUG) {
  ...
  check_stack = function() {
    ...
    if (chainOfUserSymbolsNotFunctionsBeingEvaluated.length !== 0) {
      debugger;
      return stop("symbols evaluation ongoing?");
    }
  };
  ...
  computeDependenciesFromAlgebra = function(codeFromAlgebraBlock) {
    var ae, i, keepState, len, originalcodeFromAlgebraBlock, stringToBeRun, userSimplificationsInProgramForm;
  ...
  computeResultsAndJavaScriptFromAlgebra = function(codeFromAlgebraBlock) {
    var ae, code, dependencyInfo, i, keepState, latexResult, len, originalcodeFromAlgebraBlock, readableSummaryOfCode, ref2, result, stringToBeRun, testableStringIsIgnoredHere, timeStartFromAlgebra, userSimplificationsInProgramForm;
    originalcodeFromAlgebraBlock = codeFromAlgebraBlock;
    keepState = true;
    timeStartFromAlgebra = new Date().getTime();
    if (TIMING_DEBUGS) {
  ...
  (function() {
    ...
    builtin_fns = ["abs", "add", "adj", "and", "approxratio", "arccos", "arccosh", "arcsin", "arcsinh", "arctan", "arctanh", "arg", "atomize", "besselj", "bessely", "binding", "binomial", "ceiling", "check", "choose", "circexp", "clear", "clearall", "clearpatterns", "clock", "coeff", "cofactor", "condense", "conj", "contract", "cos", "cosh", "decomp", "defint", "deg", "denominator", "det", "derivative", "dim", "dirac", "divisors", "do", "dot", "draw", "dsolve", "eigen", "eigenval", "eigenvec", "erf", "erfc", "eval", "exp", "expand", "expcos", "expsin", "factor", "factorial", "factorpoly", "filter", "float", "floor", "for", "Gamma", "gcd", "hermite", "hilbert", "imag", "component", "inner", "integral", "inv", "invg", "isinteger", "isprime", "laguerre", "lcm", "leading", "legendre", "log", "mag", "mod", "multiply", "not", "nroots", "number", "numerator", "operator", "or", "outer", "pattern", "patternsinfo", "polar", "power", "prime", "print", "print2dascii", "printfull", "printlatex", "printlist", "printplain", "product", "quote", "quotient", "rank", "rationalize", "real", "rect", "roots", "equals", "shape", "sgn", "silentpattern", "simplify", "sin", "sinh", "sqrt", "stop", "subst", "sum", "symbolsinfo", "tan", "tanh", "taylor", "test", "testeq", "testge", "testgt", "testle", "testlt", "transpose", "unit", "zero"];
    results = [];
